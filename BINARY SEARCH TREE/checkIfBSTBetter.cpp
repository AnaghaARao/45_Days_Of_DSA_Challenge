...
// TIME COMPLEXITY: BALANCED TREE- O(nlogn) // T(n) = T(n/2)+Kn
// TIME COMPLEXITY: ONE-SIDED TREE- O(n^2)  // T(n) = t(n-1)+Kn

// MAJOR DISADVANTAGE: ON EACH SUBTREE 2 TRAVERSALS OCCUR - ONCE FOR FINDING MIN/MAX AND ONCE FOR CHECKING IF isBST()
